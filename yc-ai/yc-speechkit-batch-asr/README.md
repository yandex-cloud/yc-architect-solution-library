...
Сценарий для распознавания больших архивов аудио.Аудио файлы должны быть предварительно конвертированы в формат, 
который поддерживается SpeetchKit (LPCM или Ogg) и загружены на Object Storage.
...
<li>Скачайте актуальную версию   https://dotnet.microsoft.com/download</li>
  <li>Скомпилируйте приложение или скачайте и распакуйте <a href=''> архив с релизом </a> в удобную директорию</li>
</ol>
