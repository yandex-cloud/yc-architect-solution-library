...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2frpc_2fstatus_2eproto_metadata_getter(int index);
namespace google {
namespace rpc {
class Status;
...
class Status PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2frpc_2fstatus_2eproto_metadata_getter(kIndexInFileMessages);
  }
