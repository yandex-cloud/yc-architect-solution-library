...
variable "sa_name" {
  type        = string
  description = "docker-machine service account name"
  default     = "gitlab-docker-machine"
}

variable "sa_description" {
  type        = string
  description = "docker-machine service account description"
  default     =  "gitlab-docker-machine SA"
}
