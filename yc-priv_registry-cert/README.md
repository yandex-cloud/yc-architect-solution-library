...
## Дополнительно
Вместо 5-ого пункта, можно возспользоваться интерактивным скриптом `interactive.sh`, который запросит все необходимые IDs и запустит и удалит Job, когда она будет выполнена.
